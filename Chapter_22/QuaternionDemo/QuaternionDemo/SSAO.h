...
public:
	...
	void SetComputeRootSig(ID3D12RootSignature* computeRootSig);
	void SetPSOs(ID3D12PipelineState* ssaoPso, ID3D12PipelineState* ssaoBlurPso, ID3D12PipelineState* ssaoVertBlurPso);
...
private:
	...
	ID3D12PipelineState* mSSAOHorzBlurPso = nullptr;
	ID3D12PipelineState* mSSAOVertBlurPso = nullptr;
