...
void BlendApp::BuildPSOs()
{
	...
	transparencyDesc.SrcBlend = D3D12_BLEND_ONE;
	transparencyDesc.DestBlend = D3D12_BLEND_ONE;
	...
	dds.DepthFunc = D3D12_COMPARISON_FUNC_ALWAYS;
	...
	dds.FrontFace.StencilPassOp = D3D12_STENCIL_OP_KEEP;
	...
	dds.BackFace.StencilPassOp = D3D12_STENCIL_OP_KEEP;
	dds.BackFace.StencilFunc = D3D12_COMPARISON_FUNC_ALWAYS;
	...
	opaquePsoDesc.BlendState.RenderTarget[0] = transparencyDesc;
