...
void CrateApp::BuildDescriptorHeaps()
{
	...
	auto woodTex = mTextures["woodCrate"]->Resource;
...
void CrateApp::BuildPSOs()
{
	...
	ThrowIfFailed(md3dDevice->CreateGraphicsPipelineState(&opaquePsoDesc,
		IID_PPV_ARGS(mOpaquePSO.GetAddressOf())));
}
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> CrateApp::GetStaticSamplers()
{
	...
	const CD3DX12_STATIC_SAMPLER_DESC anistropiClamp(
		5,
		D3D12_FILTER_ANISOTROPIC,
		D3D12_TEXTURE_ADDRESS_MODE_CLAMP,
		D3D12_TEXTURE_ADDRESS_MODE_CLAMP,
	...
	return { pointWrap, pointClamp, linearWrap, linearClamp, anistropicWrap, anistropiClamp };
}
