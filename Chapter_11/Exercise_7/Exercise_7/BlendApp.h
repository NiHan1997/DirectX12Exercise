...
private:
	...
	void BuildLandGeo();
	void BuildWavesGeo();
	void BuildLightningGeo();
	void BuildMaterials();
	void BuildRenderItems();
	void BuildFrameResources();
	void BuildPSOs();

	GeometryGenerator::MeshData CreateCylinderWidthoutTopAndBottom(float bottomRadius, float topRadius, float height, std::uint32_t sliceCount, std::uint32_t stackCount);
