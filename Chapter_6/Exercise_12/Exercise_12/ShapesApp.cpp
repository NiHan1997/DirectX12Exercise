...
void ShapesApp::OnResize()
{
	...
	// 视口大小需要重置.
	mRect = { 0, 0, (int)mClientWidth / 2, (int)mClientHeight / 2 };
...
void ShapesApp::Draw(const GameTimer& gt)
{
	...
	// 清除视口外的区域.
	mCommandList->ClearRenderTargetView(CurrentBackBufferView(), Colors::LightSteelBlue, 1, &mRect);
...
void ShapesApp::BuildShapesGeo()
{
	...
	{
		// Box.
		Vertex({XMFLOAT3(-2.0f, -1.0f, -1.0f), XMCOLOR(Colors::Red)}),
		Vertex({XMFLOAT3(-2.0f, 1.0f, -1.0f), XMCOLOR(Colors::Blue)}),
		Vertex({XMFLOAT3(0.0f, 1.0f, -1.0f), XMCOLOR(Colors::Yellow)}),
		Vertex({XMFLOAT3(0.0f, -1.0f, -1.0f), XMCOLOR(Colors::Green)}),
		Vertex({XMFLOAT3(-2.0f, -1.0f, 1.0f), XMCOLOR(Colors::Brown)}),
		Vertex({XMFLOAT3(-2.0f, 1.0f, 1.0f), XMCOLOR(Colors::HotPink)}),
		Vertex({XMFLOAT3(0.0f, 1.0f, 1.0f), XMCOLOR(Colors::Purple)}),
		Vertex({XMFLOAT3(0.0f, -1.0f, 1.0f), XMCOLOR(Colors::Silver)}),

		// Pyramid.
		Vertex({XMFLOAT3(1.0f, -1.0f, -1.0f), XMCOLOR(Colors::Red)}),
		Vertex({XMFLOAT3(1.0f, -1.0f, 1.0f), XMCOLOR(Colors::Blue)}),
		Vertex({XMFLOAT3(3.0f, -1.0f, 1.0f), XMCOLOR(Colors::Yellow)}),
		Vertex({XMFLOAT3(3.0f, -1.0f, -1.0f), XMCOLOR(Colors::Green)}),
		Vertex({XMFLOAT3(2.0f, 1.4f, 0.0f), XMCOLOR(Colors::Brown)})
	};
