...
void SphereApp::UpdateObjectCBs(const GameTimer& gt)
{
	...
	if (mSphereRitem->NumFramesDirty > 0)
	{
		...
		objConstants.Radius = mSphereRitem->Radius;
...
{
	mShaders["VS"] = d3dUtil::CompileShader(L"Shaders/SphereTessellation.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["HS"] = d3dUtil::CompileShader(L"Shaders/SphereTessellation.hlsl", nullptr, "HS", "hs_5_1");
	mShaders["DS"] = d3dUtil::CompileShader(L"Shaders/SphereTessellation.hlsl", nullptr, "DS", "ds_5_1");
	mShaders["PS"] = d3dUtil::CompileShader(L"Shaders/SphereTessellation.hlsl", nullptr, "PS", "ps_5_1");
...
void SphereApp::BuildRenderItem()
{
	...
	mSphereRitem->Radius = 5.0f;
	mSphereRitem->Geo = mSphereGeo.get();
	mSphereRitem->Mat = nullptr;
	mSphereRitem->PrimitiveType = D3D_PRIMITIVE_TOPOLOGY_3_CONTROL_POINT_PATCHLIST;
...
void SphereApp::BuildPSO()
{
	...
	opaqueLinePsoDesc.PrimitiveTopologyType = D3D12_PRIMITIVE_TOPOLOGY_TYPE_PATCH;
