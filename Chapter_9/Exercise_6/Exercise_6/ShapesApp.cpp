...
void ShapesApp::BuildMaterials()
{
	...
	bricks->FresnelR0 = { 0.02f, 0.02f, 0.02f };
	...
	stone->FresnelR0 = { 0.05f, 0.05f, 0.05f };
	...
	tile->DiffuseAlbedo = { 1.0f, 1.0f, 1.0f, 1.0f };
	tile->FresnelR0 = { 0.02f, 0.02f, 0.02f };
	tile->Roughness = 0.3f;
	...
	wood->DiffuseAlbedo = { 1.0f, 1.0f, 1.0f, 1.0f };
	wood->FresnelR0 = { 0.02f, 0.02f, 0.02f };
	wood->Roughness = 0.3f;
