...
void ShapesApp::Draw(const GameTimer& gt)
{
	...
	passCBHandle.Offset(mPassCbvOffset + mCurrFrameResouceIndex, mCbvSrvUavDescriptorSize);
...
void ShapesApp::BuildRootSignature()
{
	...
	slotRootParamter[0].InitAsDescriptorTable(1, &objCBTable);
...
void ShapesApp::BuildConstantsBuffers()
{
	...
	{
		auto objCB = mFrameResouces[frameIndex]->ObjectCB->Resource();
