...
class CubeMapGSApp : public D3DApp
{
public:
	CubeMapGSApp(HINSTANCE hInstance);
	CubeMapGSApp(const CubeMapGSApp& rhs) = delete;
	CubeMapGSApp& operator=(const CubeMapGSApp& rhs) = delete;
	~CubeMapGSApp();
